...
export const SECTION_TYPES = [
  ...
  },
  {
    ...
    icon: '🎞️',
    fields: [
      { key: 'media', label: 'Image or video from your library', type: 'media' },
      { key: 'embed_url', label: 'Or paste a YouTube / Vimeo URL', type: 'text', placeholder: 'https://youtube.com/watch?v=…' },
      { key: 'eyebrow', label: 'Small label above headline', type: 'text' },
      { key: 'headline', label: 'Headline', type: 'text' },
      { key: 'body', label: 'Body text', type: 'textarea' },
      { key: 'media_side', label: 'Picture/video on the', type: 'select', options: ['left', 'right'], default: 'right' },
      { key: 'size', label: 'Text size', type: 'select', options: ['small', 'medium', 'large'], default: 'medium' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'extra_images', label: 'My own extra pictures', type: 'media_multi' },
      { key: 'columns', label: 'Columns', type: 'select', options: ['2', '3', '4'], default: '4' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'extra_images', label: 'Extra clips or photos', type: 'media_multi' },
